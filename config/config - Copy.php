...
global $dirControl_databases, $httpControl_databases, $dirControl_projects, $httpControl_projects, $dirControl_loader, $httpControl_loader, $dirControl_pages, $httpControl_pages;
